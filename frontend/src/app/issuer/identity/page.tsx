      ...
      <Card className="border border-slate-200/70 bg-white/80 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            ...
            as an issuer or trusted claim provider.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {!publicKey ? (
            <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
              Connect the issuer wallet to check or register its FID.
            </div>
          ) : (
            <>
                ...
                <div className="flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-emerald-700">
                      This wallet can be used as an issuer or trusted claim
                      issuer in token deployments.
                    </div>
                  </div>
                </div>
              ) : (
